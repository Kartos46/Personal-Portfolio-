...
const About = () => {
  const skills = [
    ...
    { category: "Backend", icon: Database, skills: [
      { name: "Python (Flask/FastAPI)", level: 70 },
      { name: "PHP", level: 50 },
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="animate-slide-up">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Started my coding journey 2 years ago with a curiosity about how websites work. 
                What began as tinkering with HTML and CSS quickly evolved into a passion for full-stack development.
              </p>
              <p>
                I specialize in building modern web applications using JavaScrip and TypeScript for the frontend, 
            ...
            <div className="space-y-6">
              <Card className="shadow-card transition-smooth hover:shadow-glow">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">SPK • 2023-2026</p>
                </CardContent>
              </Card>
